...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: lenguajeGB.smsAvisoAG().slice(0,-2), body: [wm, '𝘽𝙊𝙏 𝙋𝙍𝙀𝘾𝙄𝙊𝙎𝘼' + gt + '𝗖𝗿𝗲𝗮𝗱𝗼 𝗽𝗼𝗿', '𝘽𝙊𝙏 𝙋𝙍𝙀𝘾𝙄𝙊𝙎𝘼'].getRandom(), thumbnail: gataImg, sourceUrl: accountsgb }}}}, tg)
